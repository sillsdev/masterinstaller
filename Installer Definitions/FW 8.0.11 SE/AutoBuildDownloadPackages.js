...
{
	SetElement("FlavorName1", "FW8011_SE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/8.0.11/SE/FW8011_SE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW8011_SE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/8.0.11/SE/FW8011_SE_B.exe");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 8.0.11 SE");
