...
{
	SetElement("FlavorName1", "FW725_BTE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/7.2.5/BTE/FW725_BTE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW725_BTE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/7.2.5/BTE/FW725_BTE_B.exe");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 7.2.5 BTE");
