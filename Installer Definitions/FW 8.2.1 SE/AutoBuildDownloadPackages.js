...
{
	SetElement("FlavorName1", "FW821_SE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/8.2.1/SE/FW821_SE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW821_SE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/8.2.1/SE/FW821_SE_B.exe");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 8.2.1 SE");
