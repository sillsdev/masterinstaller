...
{
	SetElement("FlavorName1", "FW806_BTE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/8.0.6/BTE/FW806_BTE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW806_BTE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/8.0.6/BTE/FW806_BTE_B.exe");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 8.0.6 BTE");
