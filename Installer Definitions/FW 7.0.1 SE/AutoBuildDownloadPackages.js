...
{
	SetElement("FlavorName1", "FW701_SE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/7.0.1/SE/FW701_SE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW701_SE_B");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 7.0.1 SE");
