...
{
	SetElement("FlavorName1", "FW732_BTE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/7.3.2/BTE/FW732_BTE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW732_BTE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/7.3.2/BTE/FW732_BTE_B.exe");
	...
	SelectElement("IncludedF2P8", true);

	NextStage();

	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 7.3.2 BTE");
