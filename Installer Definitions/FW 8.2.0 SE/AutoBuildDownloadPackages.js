...
{
	SetElement("FlavorName1", "FW820_SE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/8.2.0/SE/FW820_SE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW820_SE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/8.2.0/SE/FW820_SE_B.exe");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 8.2.0 SE");
