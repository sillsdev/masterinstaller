...
{
	SetElement("FlavorName1", "FW727_BTE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/7.2.7/BTE/FW727_BTE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW727_BTE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/7.2.7/BTE/FW727_BTE_B.exe");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 7.2.7 BTE");
