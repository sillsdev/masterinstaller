...
bool TestTsfPresence(const char * /*pszMinVersion*/, const char * /*pszMaxVersion*/, const char * /*pszCriticalFile*/)
{
	LONG lResult;
	HKEY hKey = NULL;

	lResult = RegOpenKeyEx(HKEY_CLASSES_ROOT, "CLSID\\{529A9E6B-6587-4F23-AB9E-9C7D683E3C50}",
		NULL, KEY_READ, &hKey);
	RegCloseKey(hKey);
