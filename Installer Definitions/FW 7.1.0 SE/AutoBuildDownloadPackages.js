...
{
	SetElement("FlavorName1", "FW710_SE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/7.1.0/SE/FW710_SE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW710_SE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/7.1.0/SE/FW710_SE_B.exe");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 7.1.0 SE");
