...
{
	SetElement("FlavorName1", "FW812_BTE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/8.1.2/BTE/FW812_BTE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW812_BTE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/8.1.2/BTE/FW812_BTE_B.exe");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 8.1.2 BTE");
