...
{
	SetElement("FlavorName1", "FW801_SE_A");
	SetElement("FlavorUrl1", "http://downloads.sil.org/FieldWorks/8.0.1/SE/FW801_SE_A.exe");
	AddFlavor();
	SetElement("FlavorName2", "FW801_SE_B");
	SetElement("FlavorUrl2", "http://downloads.sil.org/FieldWorks/8.0.1/SE/FW801_SE_B.exe");
	...
	SetElement("OutputPath", "G:\\Software Package Builder\\Web Downloads\\FW 8.0.1 SE");
